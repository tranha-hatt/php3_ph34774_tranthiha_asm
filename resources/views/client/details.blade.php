            ...
            <div class="col-lg-8 col-md-12 mb-30">
                <div class="news-details-layout1">
                    <div class="position-relative mb-30">
                        <img src="{{asset('client/img/news/news177.jpg')}}" alt="news-details" class="img-fluid">
                    ...
                    <img src="{{asset('client/img/news/news178.jpg')}}" alt="news-details" class="img-fluid pull-left mr-40 mb-15">
                    ...
                    <div class="author-info p-35-r mb-50 border-all">
                        <div class="media media-none-xs">
                            <img src="{{asset('client/img/author.jpg')}}" alt="author" class="img-fluid rounded-circle">
                    ...
                    <div class="comments-area">
                        ...
                        <ul>
                            <li>
                                <div class="media media-none-xs">
                                    <img src="{{asset('client/img/blog1.jpg')}}" class="img-fluid rounded-circle" alt="comments">
                            ...
                            <li>
                                <div class="media media-none-xs">
                                    <img src="{{asset('client/img/blog2.jpg')}}" class="img-fluid rounded-circle" alt="comments">
                                    <div class="media-body comments-content media-margin30">
                                        <h3 class="title-semibold-dark">
                                            <a href="#">Fahim ,
                                                <span> August 29, 2017</span>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-4 col-sm-6 col-6">
                            <div class="mt-25 position-relative">
                                ...
                                <a href="single-news-1.html" class="mb-10 display-block img-opacity-hover">
                                    <img src="{{asset('client/img/news/news171.jpg')}}" alt="ad" class="img-fluid m-auto width-100">
                                </a>
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-6 col-6">
                            <div class="mt-25 position-relative">
                                ...
                                <a href="single-news-1.html" class="mb-10 display-block img-opacity-hover">
                                    <img src="{{asset('client/img/news/news172.jpg')}}" alt="ad" class="img-fluid m-auto width-100">
                                </a>
                                <h3 class="title-medium-dark size-md mb-none">
                                    <a href="single-news-1.html">Rosie Huntington Whitl Habits Career Art.Rosie TBeauty Habits.</a>
                                </h3>
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-6 col-6">
                            <div class="mt-25 position-relative">
                                ...
                                <a href="single-news-1.html" class="mb-10 display-block img-opacity-hover">
                                    <img src="{{asset('client/img/news/news173.jpg')}}" alt="ad" class="img-fluid m-auto width-100">
                                </a>
                                <h3 class="title-medium-dark size-md mb-none">
                                    <a href="single-news-1.html">Rosie Huntington Whitl Habits Career Art.Rosie TBeauty Habits.</a>
                                </h3>
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-6 col-6">
                            <div class="mt-25 position-relative">
                                ...
                                <a href="single-news-1.html" class="mb-10 display-block img-opacity-hover">
                                    <img src="{{asset('client/img/news/news174.jpg')}}" alt="ad" class="img-fluid m-auto width-100">
                                </a>
                                <h3 class="title-medium-dark size-md mb-none">
                                    <a href="single-news-1.html">Rosie Huntington Whitl Habits Career Art.Rosie TBeauty Habits.</a>
                                </h3>
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-6 col-6">
                            <div class="mt-25 position-relative">
                                ...
                                <a href="single-news-1.html" class="mb-10 display-block img-opacity-hover">
                                    <img src="{{asset('client/img/news/news175.jpg')}}" alt="ad" class="img-fluid m-auto width-100">
                                </a>
                                <h3 class="title-medium-dark size-md mb-none">
                                    <a href="single-news-1.html">Rosie Huntington Whitl Habits Career Art.Rosie TBeauty Habits.</a>
                                </h3>
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-6 col-6">
                            <div class="mt-25 position-relative">
                                ...
                                <a href="single-news-1.html" class="mb-10 display-block img-opacity-hover">
                                    <img src="{{asset('client/img/news/news176.jpg')}}" alt="ad" class="img-fluid m-auto width-100">
                                </a>
                                <h3 class="title-medium-dark size-md mb-none">
                                    <a href="single-news-1.html">Rosie Huntington Whitl Habits Career Art.Rosie TBeauty Habits.</a>
                                </h3>
